...
class QRPlugin extends BasePlugin {
  static const MethodChannel _channel = const MethodChannel('flutter.CoinPal.io/qr');
  ...
  static Future<dynamic> launchQRCodeScan(
    ...
    if (Platform.isIOS) {
      args["iosCameraPermissionsTips"] = "Allow CoinPal to access your camera and microphone on Settings-privacy on your iPhone";
    }
