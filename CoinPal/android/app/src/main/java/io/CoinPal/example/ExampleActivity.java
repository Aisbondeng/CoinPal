...
import io.CoinPal.example.UtilPluginHandler;
import io.CoinPal.scan.ScanActivity;
...
public class ExampleActivity extends FlutterActivity {
    ...
    private static final String CRYPTO_CHANNEL = "flutter.CoinPal.io/crypto";
    private static final String QR_CHANNEL = "flutter.CoinPal.io/qr";
    private static final String UTIL_CHANNEL = "flutter.CoinPal.io/util";
    private static final String PROGRESS_CHANNEL ="flutter.CoinPal.io/HUDProgress";
    ...
    io.CoinPal.example.CustomDialog dialog;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
         dialog = new io.CoinPal.example.CustomDialog(io.CoinPal.example.ExampleActivity.this);
    }
    ...
    public void showQRScanView(MethodCall call, MethodChannel.Result result) {
        ...
        intent.setClass(io.CoinPal.example.ExampleActivity.this, ScanActivity.class);
